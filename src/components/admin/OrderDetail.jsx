...
import deleteOrder from "../../context/myState"
          ...
          <table className="w-full text-left border border-collapse sm:border-separate border-pink-100 text-pink-400">
            <tbody>
              ...
              {getAllOrder.map((order, orderIndex) => {
                let serialNumber = orderIndex * order.cartItems.length; // Initialize serialNumber
                ...
                return order.cartItems.map((item, itemIndex) => {
                  ...
                  serialNumber++; // Increment serialNumber for each row

                  return (
                    <tr key={itemIndex} className="text-pink-300">
